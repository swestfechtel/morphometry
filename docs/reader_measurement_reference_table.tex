...
\begin{itemize}[leftmargin=1.4em,itemsep=2pt,topsep=2pt]
  ...
  \item ``Side'' is the \emph{image} side, not the patient side (see guide \S0.2).
\end{itemize}
...
segment and the knee$\rightarrow$ankle segment. \textbf{This pipeline reports deviation
from straight (0\textdegree{} = perfectly straight), not the 180\textdegree{}-based
convention.} &
