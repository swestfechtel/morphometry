...
// The app's interactive shell: sticky navbar (nav links, disclaimer, auth control,
// language selector and dark-mode toggle), the themed <main> wrapper, and the footer.
// Split out of the (now server) layout so the layout can resolve the locale on the
// server while this client component owns the dark-mode state and the toggles.
    ...
    return (
        <>
            <nav className="sticky w-full top-0 z-50 bg-gray-900 p-4 flex items-center justify-between">
                        ...
                        <Link href="/examinations/">
                            <div className="hover:bg-gray-600 p-2">
                                <div className="flex items-center">
                                    ...
                                    <p className="text-white hover:text-gray-300 ml-2">{t('nav.examinations')}</p>
                                </div>
                            </div>
                        </Link>
                    </li>
                        ...
                        <Link href="/upload">
                            <div className="hover:bg-gray-600 p-2">
                                <div className="flex items-center">
                                    ...
                                    <p className="text-white hover:text-gray-300 ml-2">{t('nav.upload')}</p>
                                </div>
                            </div>
                        </Link>
                    </li>
                        ...
                        <Link href="/about">
                            <div className="hover:bg-gray-600 p-2">
                                <div className="flex items-center">
                                    ...
                                    <p className="text-white hover:text-gray-300 ml-2">{t('nav.about')}</p>
                                </div>
                            </div>
                        </Link>
                    </li>
                ...
                <div className="flex items-center">
                    <p className="text-white text-lg font-bold">{t('nav.disclaimer')}</p>
                </div>
                ...
                <div className="flex items-center">
                    <LanguageSwitcher />
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                         className="bi bi-brightness-high mr-3 ml-3" viewBox="0 0 16 16">
                        <path
